...
import 'package:app/screens/benevole/add_benevole.dart';
...
class _BenevoleState extends State<Benevole> {
    ...
    Future<void> fetch() async {
        Cafe? selectedCafe = Provider.of<CafeProvider>(context, listen: false).selectedCafe;
        //print(selectedCafe?.name);
        //await Provider.of<VolunteerProvider>(context, listen: false).fetchVolunteer();
        if (selectedCafe != null) {
            await Provider.of<VolunteerProvider>(context, listen: false).fetchVolunteer(selectedCafe.name);
        }
    }
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
                return AlertDialog(
                    ...
                    content: Text("Are you sure you want to delete $username as a volunteer?"),
                    actions: [
                        TextButton(
                        onPressed: () {
                        ...
                        TextButton(
                            onPressed: () async {
                                ...
                                Cafe? selectedCafe = Provider.of<CafeProvider>(context, listen: false).selectedCafe;
                                String response = await VolunteerService().deleteVolunteer(selectedCafe!.slug, username);
                                ...
                                if (response == "Success: Volunteer deleted successfully.") {
                                    volunteerProvider.removeVolunteer(username); // Update the vonlonteers'slist
                                }
