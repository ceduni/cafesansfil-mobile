...
import { MainController } from "../../src/contollers/mainController"; // Corrected path - it was `contollers`
...
describe("MessageRoutes", () => {
    ...
    describe("GET /messages/:senderId/:receiverId", () => {
        it("should return messages successfully", async () => {
            ...
            const response = await request(server.App)
                .get(`/api/v1/messages/${mockMessage.senderId}/${mockMessage.receiverId}`);
